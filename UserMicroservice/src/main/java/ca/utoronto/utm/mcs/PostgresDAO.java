...
public class PostgresDAO {
    ...
    public ResultSet postUser(String email, String password, String prefer_name) throws SQLException {
        String query =  "INSERT INTO users (email, prefer_name, password, rides) VALUES ('%s', '%s', '%s', 0) RETURNING  uid";
